...
function (_Component) {
  ...
  function Navigation() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "handleClick", function (e) {
      ...
      // const key = window.location.href.split('/')[length - 1];
      // console.log('click ', window.location.href.split('/')[window.location.href.split('/').length-1]);
      // e.preventDefault();
      _this.setState({
        current: e.key
      });
...
//# sourceMappingURL=index.js.4d2d6ce91ff0355b48db.hot-update.js.map